...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	var gallery = cont.find('.gallery_wrap:not(.inited)');
	if (gallery.length == 0 || gallery.parents('div:hidden,article:hidden').length > 0) return;
	gallery = gallery.addClass('inited').get(0);
